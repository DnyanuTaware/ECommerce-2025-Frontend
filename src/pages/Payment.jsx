  ...
  const paymentHandler = async () => {
    ...
    if (method === "online") {
      const stripePromise = loadStripe(
        "=pk_test_51RfZ0xFybinKynB4jDgNsOfSleS1X52M75VFv4oPPZpVXdSs7IrNoecENLit0pkdNfOABRmPzuoUeWL3pfwd6Wf60044eBhwG7"
      );
      ...
      try {
        ...
        toast.error("Payment failed plz Try Again");
        setLoading(false);
      }
    }
  };
                  ...
                  cart.map((e, i) => (
                    ...
                    >
                      ...
                      <div className="flex-1 md:ml-4 text-center md:text-left">
                        ...
                        <p className="text-sm text-muted-forground dark:text-gray-400">
            ...
            {address && (
              <div className="bg-card p-4 rounded-lg shadow border space-y-4 dark:border-gray-700">
                ...
                <div className="flex flex-col  space-y-4">
                  ...
                  <div className="w-full md:w-1/2 dark:text-black">
