...
import { Home, Info, Menu, MenuIcon, ShoppingBag, X } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div
        ...
        } fixed lg:relative lg:translate-x-0 shadow-lg transition-transform duration-300 bg-background/50 min-h-screen backdrop-blur z-50`}
      >
        <div className="flex flex-col h-full p-4">
          ...
          <div className="space-y-4">
            <Button
              ...
              className={`w-full flex items-center gap-2  shadow hover:border ${
            ...
            <Button
              variant="ghost"
              className="lg:hidden w-full flex items-center gap-2 shadow hover:border"
